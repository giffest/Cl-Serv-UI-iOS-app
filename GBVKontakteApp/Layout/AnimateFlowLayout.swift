...
class AnimateFlowLayout: UICollectionViewFlowLayout {
    ...
    private func setup() {
        ...
        itemSize = CGSize(width: collectionView!.bounds.width + minimumLineSpacing, height: collectionView!.bounds.height / 1.5)
